...
func Connect() (err error) {
	...
	if err = engine.AutoMigrate(
		...
		// new(User),
		new(User),
		new(UserFollowersCount),
		new(UserFollowingCount),
		new(Repo),
		new(Topic),
		new(RepoForksCount),
		new(RepoNetworkCount),
		new(RepoOpenIssuesCount),
		new(RepoStargazersCount),
		new(RepoSubscribersCount),
		new(RepoWatchersCount),
		// new(HistoryUserGistNum),
		// new(HistoryUserReposNum),
		// new(UserFollowing),
		// new(UserFollowers),
		// new(RepoStargazers),
		// new(RepoWatchers),
