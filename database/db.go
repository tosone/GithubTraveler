...
func Connect() (err error) {
	...
	if err = engine.AutoMigrate(
		new(tables.User),
		new(tables.UserFollowersCount),
		new(tables.UserFollowingCount),
		new(tables.Repo),
		new(tables.Topic),
		new(tables.RepoForksCount),
		new(tables.RepoNetworkCount),
		new(tables.RepoOpenIssuesCount),
		new(tables.RepoStargazersCount),
		new(tables.RepoSubscribersCount),
		new(tables.RepoWatchersCount),
	).Error; err != nil {
